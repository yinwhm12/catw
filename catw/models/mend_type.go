...
type EndType struct {
	...
	LevelName string `json:"level_name,omitempty" orm:"column(level_name);size(11)" json:"-"`
	...
	Root1Type *Root1Type `json:"root_1_type" orm:"rel(fk)"`
	Root2Type *Root2Type `json:"root_2_type" orm:"rel(fk)"`
	LevelType *LevelType `json:"level_type" orm:"rel(fk)"`
